...
// script for the CSS question quiz

const CSSstart_btn = document.querySelector(".interest_session .interests .btn4");

CSSstart_btn.onclick = () => {
...
next_btn.onclick = ()=>{
    if(que_count < CSSquestions.length - 1){ //if question count is less than total question length
...
function showQuetions(index){
    ...
    let que_tag = '<span>'+ CSSquestions[index].numb + ". " + CSSquestions[index].question +'</span>';
...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>and congrats! 🎉, You got <p>'+ userScore +'</p> out of <p>'+ CSSquestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span>and nice 😎, You got <p>'+ userScore +'</p> out of <p>'+ CSSquestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{ // if user scored less than 1
        let scoreTag = '<span>and sorry 😐, You got only <p>'+ userScore +'</p> out of <p>'+ CSSquestions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
function queCounter(index){
    ...
    let totalQueCounTag = '<span><p>'+ index +'</p> of <p>'+ CSSquestions.length +'</p> Questions</span>';
